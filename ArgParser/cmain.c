...
void show_help( const char verbose )
  {
  printf( "%s - A POSIX/GNU command line argument parser. (C version)\n", Program_name );
  ...
  printf( "  -a, --append                 example of option with no argument\n" );
  printf( "  -b, --block=<arg>            example of option with required argument\n" );
  printf( "  -c, --casual[=<arg>]         example of option with optional argument\n" );
  printf( "  -o <arg>                     example of short only option\n" );
  printf( "      --orphan                 example of long only option\n" );
  printf( "  -q, --quiet                  quiet operation\n" );
  printf( "  -u, --uncaught               example of intentional bug\n" );
  ...
  printf( "Arg_parser home page: http://www.nongnu.org/arg-parser/arg_parser.html\n" );
  }
